...
public class four extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("1)Attach the text file");

        jLabel2.setText("2)Enter the Specific term to be analyzed for eg:- music");

        jLabel3.setText("2)Display the sentiment by clicking START button");
